...
%
%    D = RSKELF_DIAG(F,DINV) computes the diagonal of F if DINV = 0 (default)
%    and the diagonal of INV(F) if DINV = 1.
%
%    D = RSKEL_DIAGINV(F,DINV,OPTS) also passes various options to
