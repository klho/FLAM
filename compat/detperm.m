...
%
%   D = DETPERM(P) computes the determinant (i.e., sign) D of the permutation P.
%
%   In both MATLAB and Octave, this is done by calling DET on the associated
%   permutation matrix, which for efficiency should be represented explicitly as
%   sparse in the former but as dense (internally recognized as a permutation
